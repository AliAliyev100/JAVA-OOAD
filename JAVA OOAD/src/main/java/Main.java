        ...
        while(true) {
            ...
            while (true) {
                ...
                if (userAction == 1) {
                    ...
                    addedProduct = ((Admin) currentuser).createProduct(productType, productName, productDescription, pricePerUnitOfProduduct, expiryYear, expiryMonth, expirtyDate);
